...
export const SeriesIcon = (p) => (
  <I {...p}>
    <path d="M2 12a10 10 0 0 1 10-10 10 10 0 0 1 8.6 4.9" />
    <polyline points="21 2 21 7 16 7" />
    <path d="M22 12a10 10 0 0 1-10 10 10 10 0 0 1-8.6-4.9" />
    <polyline points="3 22 3 17 8 17" />
...
export const ZeroIcon = (p) => (
  <I {...p}>
    <circle cx="12" cy="12" r="9" />
    <path d="M12 7v5l3 2" />
    <path d="M12 3V1M21 12h2" />
  </I>
);
export const DigestIcon = (p) => (
  <I {...p}>
